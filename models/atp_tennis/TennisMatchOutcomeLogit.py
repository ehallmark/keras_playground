...
all_data_file = '/home/ehallmark/repos/keras_playground/models/atp_tennis/all_match_outcome_data.hdf'
def load_data(attributes, test_season='2017-01-01', start_year='1995-01-01', keep_nulls=False, masters_min=101, reload=False, save=False):
    if reload:
        print("Reloading data from hdf file...")
        sql = pd.read_hdf(all_data_file, 'data')
        if not keep_nulls:
            # handle nulls
            pass  # TODO
    else:
        ...
        if save:
            ...
            sql.to_hdf(all_data_file, 'data', mode='w')
