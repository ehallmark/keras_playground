...
test_data, test_data_2018 = tennis_model.load_data(start_year=tennis_model.start_year, test_year=datetime.date.today(), num_test_years=1, models=models, test_tournament='washington', spread_models=None)
